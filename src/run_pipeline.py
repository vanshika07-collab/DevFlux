...
from fetcher import trigger_and_download_snapshot
...
def main():
    ...
    # Step 0: Live Scraper Studio Collector API Fetch (optional if token exists)
    print("STEP 0: BRIGHT DATA COLLECTOR TRIGGER & INGESTION")
    print("-" * 60)
